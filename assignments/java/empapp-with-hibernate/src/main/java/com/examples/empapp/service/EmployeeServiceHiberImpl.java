...
public class EmployeeServiceHiberImpl implements EmployeeService{
	private static EmployeeDao hibDao = new HibernateDaoImpl();
...
//				employees.put(employee.getEmpId(), employee);
	...
	public void bulkExport() {
		...
		try (FileWriter out = new FileWriter(".\\output\\employee-output-hibernate.txt")) {
			hibDao.getAllEmpHi().stream().map(emp -> emp.getEmpId() + "," + emp.getName() + "," + emp.getAge() + ","
